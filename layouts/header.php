                    ...
                    <div class="col pl-0">
                        <button class="navbar-toggler d-flex align-items-center float-right pr-0" type="button" data-toggle="menu" data-target="#menu">
                            ...
                            <svg width="14" height="18" viewBox="0 0 14 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M0 0H14V2H0V0Z" fill="#FEBD0F"></path>
                                <path d="M0 8H14V10H0V8Z" fill="#FEBD0F"></path>
                                <path d="M0 16H14V18H0V16Z" fill="#FEBD0F"></path>
                            </svg>
                        </button>
                    </div>
                </div>
